...
title: UTSC Library borrowing policy
source_url: https://utsc.library.utoronto.ca/borrowing
retrieved_at: 2026-09-19
document_version: 2025-12-17
audience: student
department: library
...
Contents: Loan privileges | Renewals & returns | Request a hold | Recalls | Fines | Fees for lost & damaged items
...
| Item | Loan period | Maximum potential loan period | Holds |
| --- | --- | --- | --- |
| Books | 14 days | 1 renewal, 14 days | Yes |
...
| Item | Loan period | Renewals | Item limit |
| --- | --- | --- | --- |
| Periodicals | 4 day loan period | No renewals | 5 items |
...
Complete this application form to request this service (UTORid login required)
